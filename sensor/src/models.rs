...
pub enum ClassificationReason {
    ...
    SourceDefaultPortProbeSuccess,
    SourceDefaultPortProbeTimeout,
    SourceDefaultPortProbeRefused,
    SourceDefaultPortProbeIoError,
    MissingAdvertisedAddress,
    AdvertisedPrivateAddress,
    SourceDefaultPortPrivateAddress,
...
impl ClassificationReason {
    pub fn as_metric_label(&self) -> &'static str {
        match self {
            ...
            Self::SourceDefaultPortProbeSuccess => "source_default_port_probe_success",
            Self::SourceDefaultPortProbeTimeout => "source_default_port_probe_timeout",
            Self::SourceDefaultPortProbeRefused => "source_default_port_probe_refused",
            Self::SourceDefaultPortProbeIoError => "source_default_port_probe_io_error",
            Self::MissingAdvertisedAddress => "missing_advertised_address",
            Self::AdvertisedPrivateAddress => "advertised_private_address",
            Self::SourceDefaultPortPrivateAddress => "source_default_port_private_address",
