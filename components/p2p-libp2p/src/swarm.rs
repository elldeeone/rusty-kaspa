...
use libp2p::yamux;
use libp2p::{identity, swarm::SwarmBuilder, Multiaddr, Swarm, Transport};
use log::info;

/// Minimal libp2p behaviour used as a base transport until custom protocols are added.
...
/// Convert a multiaddr to a printable string for logging.
