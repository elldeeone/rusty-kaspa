...
- [x] **Proto additions (optional fields, additive):**
...
- [x] Never store RFC1918/CGNAT/loopback addresses as keys for private reachability.
...
- [x] **Dial target abstraction (minimal change):**
...
- [x] **Distinct relay per target (practical meaning):**
